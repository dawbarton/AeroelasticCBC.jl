...
function trace_from_equilibrium(p0)
    ...
    opts_br = ContinuationPar(pMin = 0.0, pMax = 25.0, ds = -0.1, dsmax = 0.1,
                              nInversion = 8,
                              detectBifurcation = 3, maxBisectionSteps = 25, nev = 3,
                              plotEveryStep = 20,
                              maxSteps = 1000, θ = 0.3)
    ...
    opts_po_cont = ContinuationPar(dsmax = 0.1, ds = -0.01, dsmin = 1e-4, pMax = 25.0,
                                   pMin = 0.0, maxSteps = 200,
                                   newtonOptions = (@set optn_po.tol = 1e-8), nev = 3,
                                   tolStability = 1e-4, detectBifurcation = 3,
                                   plotEveryStep = 20, saveSolEveryStep = 1,
                                   nInversion = 6)
